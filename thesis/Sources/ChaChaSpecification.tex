...
\begin{remark}
We define one row, consisting of one 32-bit addition, one XOR and one shift operation, as one \textit{quarter-round step}. This naming convention will be reused in Section \autoref{sec:userInterface}.
\end{remark}
