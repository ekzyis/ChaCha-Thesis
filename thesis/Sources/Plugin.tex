...
On page exit, \texttt{ChaChaPresentationViewModel}, which is the view model which implements navigation between the different pages (which have their own view models), calls \texttt{Teardown} on the page we are leaving. This triggers the ChaCha execution with the given secondary values.
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{figures/code/nav-arch/async-navigation.png}
...
\begin{figure}[hbt]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{figures/pyplot/performance_navsystem-linear.png}}
\caption{Performance of linear navigation system}
\label{fig:navsystem.performance.linear}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{figures/pyplot/performance_navsystem-central.png}}
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{figures/pyplot/performance_navsystem-round-cache.png}}
\caption{Performance of linear navigation system with caches for each round}
\label{fig:navsystem.performance.round}
\makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{figures/pyplot/performance_navsystem-qr-cache.png}}
