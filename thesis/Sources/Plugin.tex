...
Nonetheless, this did not help in tracking down the bug because it was not known on which action the error happened. This only lead to further incentivization to reiterate on the navigation system again.
