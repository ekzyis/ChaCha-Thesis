...
The plugin should support all variants of the cipher. This means that the user should be able to choose the key size (128-bit or 256-bit) and for how many rounds the hash function should be executed per keystream block (8, 12 or 20 rounds). 
