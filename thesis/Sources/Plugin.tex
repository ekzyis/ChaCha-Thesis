...
The State Matrix Initialization page shows the setup of the initial 512-bit state for the first keystream block. The generation of the following keystream blocks start with the same state but with a different counter (as described in Chapter \ref{chap:chacha}). Figure \ref{fig:statematrixpage} shows the page in its initial state.
