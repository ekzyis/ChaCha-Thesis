...
Performance plots created with matplotlib v3.3.3 (\url{https://matplotlib.org/}).\\(Profiling was done in Release mode and with an Intel\textsuperscript{\textregistered} i3-4130 @ 3.40 GHz.)\\
