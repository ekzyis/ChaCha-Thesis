...
% (cosmetics) adapt too small distance between lines of title
{\huge{Implementation and Didactical Visualization of the ChaCha Cipher Family in CrypTool 2}\par} % Title
...
Performance plots are created with matplotlib v3.3.3 (\url{https://matplotlib.org/}).\\Profiling was done in Release mode and with an Intel\textsuperscript{\textregistered} i3-4130 @ 3.40 GHz.\\
Architecture diagrams are created with diagrams.net (\url{https://www.diagrams.net/}). \\
Code screenshots are created with Carbon (\url{https://carbon.now.sh/}).
