...
{\huge Title of the Thesis}\\[0.2\baselineskip] % Title
...
{\Large Master's Thesis\\[\baselineskip]} % Tagline(s) or further description
\vspace*{\baselineskip}

{\LARGE Name Surname\\[\baselineskip]} % Editor list  

\vspace*{\baselineskip} % Whitespace between location/year and editors

Supervisor\\
{\large  Prof. Dr. Name Surname\\[\baselineskip]} % Editor list
